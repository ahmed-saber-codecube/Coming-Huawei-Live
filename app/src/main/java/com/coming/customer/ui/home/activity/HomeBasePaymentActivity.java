...
import com.coming.customer.ui.payment.Constants;
import com.coming.customer.ui.payment.PaymentStatusRequestAsyncTask;
import com.coming.customer.ui.payment.PaymentStatusRequestListener;
 ...
 */
public class HomeBasePaymentActivity extends BaseActivity implements CheckoutIdRequestListener, PaymentStatusRequestListener {
    ...
    protected boolean hasCallbackScheme(Intent intent) {
        ...
        return getString(R.string.home_checkout_ui_callback_scheme).equals(scheme) ||
                getString(R.string.home_payment_button_callback_scheme).equals(scheme) ||
                getString(R.string.home_custom_ui_callback_scheme).equals(scheme);
    }
...
//                    showToast(error.getErrorInfo());
    ...
    protected void requestCheckoutId(String total, String userId, String cardType) {
        ...
        totalAmount = total;
        new HomeCheckoutIdRequestAsyncTask(this, this).execute(total, userId, cardType);
    }
...
//        showToast(getString(R.string.message_unsuccessful_payment));
    ...
    //call API
    void checkBookingPaymentStatus(HomeBasePaymentActivity p) {
        if (p != null) {
            if (p instanceof HomeActivity) {
                ((HomeActivity) p).checkPaymentStatus();
            }
        }
    }
