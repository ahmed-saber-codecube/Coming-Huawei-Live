package com.coming.customer.ui.test
...
import com.coming.customer.ui.test.util.AnimationUtils
import com.coming.customer.ui.test.util.MapUtils
...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var googleMap: HuaweiMap
        ...
        runnable = Runnable {
            run {
                if (index < 10) {
                    ...
                    Toast.makeText(this@MainActivity, "Trip Ends", Toast.LENGTH_SHORT).show()
                }
            }
        }
