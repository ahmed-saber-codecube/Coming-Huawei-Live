...
class OrdersAdapter(private var dataSet: ArrayList<OrderList>, var callBack: OnOrderSelectedListener) : RecyclerView.Adapter<OrdersAdapter.OrderViewHolder>() {
...
//            textViewOrderPrice.text = resources.getString(R.string.label_currency) + " " + orderList.grandTotal
            ...
            when (orderList.status) {
                ...
                AppCommon.OrderStatus.DRIVER_ACCEPT -> {
                    textViewOrderStatus.text = textViewOrderStatus.context.resources.getString(R.string.order_status_driver_accept)
                    textViewOrderStatus.setTextColor(ContextCompat.getColor(itemView.context, R.color.colorStatusOpen))
                    textViewOfferBadge.visibility = View.INVISIBLE
                    itemView.setOnClickListener {
                        callBack.onOrderSelected(orderList)
                ...
                AppCommon.OrderStatus.PENDING -> {
                    textViewOrderStatus.text = textViewOrderStatus.context.resources.getString(R.string.order_status_pending)
                    textViewOrderStatus.setTextColor(ContextCompat.getColor(itemView.context, R.color.colorStatusOpen))
                    textViewOfferBadge.visibility = View.INVISIBLE
                    itemView.setOnClickListener {
                        callBack.onOrderSelected(orderList)
...
//                    textViewOfferBadge.visibility = View.INVISIBLE
//                }
                AppCommon.OrderStatus.ARRIVED -> {
                    textViewOrderStatus.text = textViewOrderStatus.context.resources.getString(R.string.order_status_arrived)
                    textViewOrderStatus.setTextColor(ContextCompat.getColor(itemView.context, R.color.colorStatusOpen))
                    textViewOfferBadge.visibility = View.INVISIBLE
                    itemView.setOnClickListener {
                        callBack.onOrderSelected(orderList)
